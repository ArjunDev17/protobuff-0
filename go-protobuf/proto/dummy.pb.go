...
func (x *Dummmy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Dummmy) ProtoMessage() {}

func (x *Dummmy) ProtoReflect() protoreflect.Message {
	mi := &file_dummy_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use Dummmy.ProtoReflect.Descriptor instead.
func (*Dummmy) Descriptor() ([]byte, []int) {
	return file_dummy_proto_rawDescGZIP(), []int{0}
}

func (x *Dummmy) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_dummy_proto_rawDesc = []byte{
	...
	0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x64, 0x75, 0x6d, 0x6d, 0x79, 0x22, 0x18, 0x0a, 0x06,
	0x44, 0x75, 0x6d, 0x6d, 0x6d, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x42, 0x15, 0x5a, 0x13, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
...
var file_dummy_proto_goTypes = []any{
	(*Dummmy)(nil), // 0: example.dummy.Dummmy
}
