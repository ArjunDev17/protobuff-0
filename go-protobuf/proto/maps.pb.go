...
func (x *MapsEx) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapsEx) ProtoMessage() {}

func (x *MapsEx) ProtoReflect() protoreflect.Message {
	mi := &file_maps_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapsEx.ProtoReflect.Descriptor instead.
func (*MapsEx) Descriptor() ([]byte, []int) {
	return file_maps_proto_rawDescGZIP(), []int{1}
}

func (x *MapsEx) GetIds() map[string]*IdWrapper {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_maps_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x22, 0x8a, 0x01, 0x0a, 0x06, 0x6d, 0x61, 0x70, 0x73,
	0x45, 0x78, 0x12, 0x2f, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1d, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x6d, 0x61, 0x70, 0x73, 0x2e, 0x6d,
	0x61, 0x70, 0x73, 0x45, 0x78, 0x2e, 0x49, 0x64, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x03,
	0x69, 0x64, 0x73, 0x1a, 0x4f, 0x0a, 0x08, 0x49, 0x64, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	...
	0x3a, 0x02, 0x38, 0x01, 0x42, 0x15, 0x5a, 0x13, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e,
...
var file_maps_proto_goTypes = []any{
	...
	(*MapsEx)(nil),    // 1: example.maps.mapsEx
	nil,               // 2: example.maps.mapsEx.IdsEntry
}
var file_maps_proto_depIdxs = []int32{
	2, // 0: example.maps.mapsEx.ids:type_name -> example.maps.mapsEx.IdsEntry
	0, // 1: example.maps.mapsEx.IdsEntry.value:type_name -> example.maps.IdWrapper
