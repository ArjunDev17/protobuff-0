...
/* @@protoc_insertion_point(class_definition:Address) */ {
 public:
  ...
  Address* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "Address"; }
...
inline ::Building* Address::_internal_mutable_building() {
  ...
  if (_impl_.building_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::Building>(GetArena());
